...
function displayTrackers() {
    ...
    for (const t of trackers) {
        let tracker = `
            ...
            <a href="#"
                class="font-small text-blue-600 dark:text-blue-500 hover:underline" onclick="removeTracker('${t.device_token}', '${t.campground_id}', '${t.campground_name}', '${t.start_date}', '${t.end_date}')"><svg
                    fill="none" stroke="currentColor" stroke-width="1.0" viewBox="0 0 24 24"
